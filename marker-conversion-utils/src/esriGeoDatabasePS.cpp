...
static PyMethodDef _esriGeoDatabasePSMethods[] = {
    {NULL, NULL, 0, NULL}
};
...
extern "C" {
    ...
    init_esriGeoDatabasePS(void)
    {
        ...
        PyObject* module;
        module = Py_InitModule3("cartocomutils._esriGeoDatabasePS",
                                 _esriGeoDatabasePSMethods,
                                "Type library");
        Py_INCREF(module);
